                ...
                <div class="row">
                    ...
                    <?php $items = getCartItems();
                        if (mysqli_num_rows($items)) {
                                        ...
                                        ?>
                                            <div class="card product-data shadow-sm mb-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-2">
                                                        <button class="btn btn-outline-danger btn-sm deleteItem" value="<?= $citem['cid']; ?>"><i class="fa fa-trash me-2"></i>Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                            ...
                            ?>
                                <div class="card card-body shadow text-center text-success">
